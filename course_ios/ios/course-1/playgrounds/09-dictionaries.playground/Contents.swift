...
animals["cow"] = "Calm animal"
animals["cat"] = "lazy animal"
animals["dog"] = "loyal animal"
animals["bird"] = nil

for (animalName, animalDesc) in animals {
    print("Animal: \(animalName) -- Description:\(animalDesc)")
}
